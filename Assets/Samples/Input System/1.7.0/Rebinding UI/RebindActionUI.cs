...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private void SaveActionBinding()
        {
            ...
            PlayerPrefs.SetString(m_Action.name + bindingId, currentBindings);
        }

        private void LoadActionBinding()
        {
            var saveBindigs = PlayerPrefs.GetString(m_Action.name + bindingId);
            if(!string.IsNullOrEmpty(saveBindigs))
            {
                actionReference.action.actionMap.LoadBindingOverridesFromJson(saveBindigs);
            }
        }
